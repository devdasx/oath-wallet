...
struct WalletSwitcherImportPassphraseScreen: View {
        ...
        List {
            Group {
                Section {
                    ...
                    .walletTextInputSubmitAction(identifier: "switcherImportPassphrase", returnKeyType: .next) {
                    ...
                    .walletTextInputSubmitAction(identifier: "switcherImportConfirmation", returnKeyType: .done) {
                        focusedField = nil
                    }
                    .textInputAutocapitalization(.never)
                    .autocorrectionDisabled()
