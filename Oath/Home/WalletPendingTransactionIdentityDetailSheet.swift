...
struct WalletPendingTransactionIdentityDetail: Identifiable {
...
extension WalletTransactionKind {
    var pendingActivityDetailsAddressOrder:
        [WalletPendingTransactionIdentityDetail.Kind]
    {
        [.fromAddress, .toAddress]
    }
}

struct WalletPendingTransactionIdentityDetailSheet: View {
    let detail: WalletPendingTransactionIdentityDetail
