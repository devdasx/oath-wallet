...
enum ICloudWalletRestoreLoadFailure: Equatable {
  ...
  var localizationKey: String {
    switch self {
    case .accountUnavailable:
      "import.icloud.unavailable"
    case .invalidBackupDocument:
      "import.icloud.error.invalid_record"
    case .storageUnavailable:
      "settings.wallets.backup.icloud.drive.error"
    case .unexpected:
      "import.icloud.error.unexpected"
    }
  }
...
@MainActor
@Observable
final class ICloudWalletRestoreDiscoveryModel {
