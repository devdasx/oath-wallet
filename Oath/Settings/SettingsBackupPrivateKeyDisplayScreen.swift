...
struct SettingsBackupPrivateKeyDisplayScreen: View {
    ...
    private func privateKeyCard(
        ...
        WalletQRCodeCard(
            ...
            codeAccessibilityIdentifier: "settings.backup.private_key.export.qr",
        ...
        .accessibilityIdentifier("settings.backup.private_key.export.card")
    }
    ...
    private func copyButton(
        ...
        return Button(action: UniHaptic.action(.successQuiet) {
            ...
            SettingsBackupPrivateKeyActionLabel(
                title: title
            )
        }
...
private struct SettingsBackupPrivateKeyActionLabel: View {
    let title: String
