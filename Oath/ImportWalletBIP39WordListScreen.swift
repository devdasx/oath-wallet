...
@MainActor
struct ImportWalletBIP39WordListScreen: View {
...
extension BIP39Language {
    var localizationKey: String {
        ...
        case .chineseSimplified:
            "import.recovery.word_list.language.chinese_simplified"
        case .chineseTraditional:
            "import.recovery.word_list.language.chinese_traditional"
        case .czech:
            "import.recovery.word_list.language.czech"
        case .english:
            "import.recovery.word_list.language.english"
        case .french:
            "import.recovery.word_list.language.french"
        case .italian:
            "import.recovery.word_list.language.italian"
        case .japanese:
            "import.recovery.word_list.language.japanese"
        case .korean:
            "import.recovery.word_list.language.korean"
        case .portuguese:
            "import.recovery.word_list.language.portuguese"
        case .spanish:
            "import.recovery.word_list.language.spanish"
        }
    }
...
#Preview {
    NavigationStack {
        ImportWalletBIP39WordListScreen(initialLanguage: .english)
    }
}
