...
struct OnboardingPhysicalEntropyPassphraseScreen: View {
        ...
        List {
            Group {
                Section {
                    ...
                    .walletTextInputSubmitAction(identifier: "onboardingEntropyPassphrase", returnKeyType: .next) {
                    ...
                    .walletTextInputSubmitAction(identifier: "onboardingEntropyConfirmation", returnKeyType: .done) {
                        focusedField = nil
                    }
                    .textInputAutocapitalization(.never)
                    .autocorrectionDisabled()
