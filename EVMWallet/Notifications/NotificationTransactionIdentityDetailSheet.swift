...
struct NotificationTransactionIdentityDetail: Identifiable {
...
struct NotificationTransactionIdentityDetailSheet: View {
    let detail: NotificationTransactionIdentityDetail
